...
<div class="moduleBox">
    ...
    <div class="content">
		...
		<a href="<?php echo osc_href_link(FILENAME_PDF, 'module=account&pdf=credit_slip&credit_slip_id=' . $Qslips->value('credit_slips_id')); ?>" class="btn btn-mini pull-right"><i class="icon-print icon-white"></i> <?php echo $osC_Language->get('credit_slips'); ?></a>
    </div>
</div>
