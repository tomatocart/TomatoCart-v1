...
*/
  ...
  class toC_Json_Modules_Order_Total {

    function listOrderTotalModules() {
    ...
    function install() {
      ...
      if ( file_exists('includes/modules/order_total/' . $code . '.php') ) {
        $osC_Language->injectDefinitions('modules/order_total/' . $code . '.xml');

        include('includes/modules/order_total/' . $code . '.php');

        $module = 'osC_OrderTotal_' . $code;
        $module = new $module();
    ...
    function getConfigurationOptions(){
      ...
      include('includes/modules/order_total/' . $_REQUEST['code'] . '.php');
    
      $osC_Language->injectDefinitions('modules/order_total/' . $_REQUEST['code'] . '.xml');
    
      $module = 'osC_OrderTotal_' . $_REQUEST['code'];
      $module = new $module();
