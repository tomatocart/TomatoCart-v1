<?php
/*
  $Id: information_general_panel.php $
...
Toc.information.GeneralPanel = function(config) {
  config = config || {};    
  ...
  Toc.information.GeneralPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.information.GeneralPanel, Ext.TabPanel, {
