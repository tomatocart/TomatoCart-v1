<?php
/*
  $Id: articles_meta_info_panel.php $
...
Toc.articles.MetaInfoPanel = function(config) {
  config = config || {};
  ...
  Toc.articles.MetaInfoPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.articles.MetaInfoPanel, Ext.TabPanel, {
  buildForm: function() {
    var panels = [];
