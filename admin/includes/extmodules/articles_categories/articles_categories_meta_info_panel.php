<?php
/*
  $Id: articles_categories_meta_info_panel.php $
...
Toc.articles_categories.MetaInfoPanel = function(config) {
  config = config || {};
  ...
  Toc.articles_categories.MetaInfoPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.articles_categories.MetaInfoPanel, Ext.TabPanel, {
  buildForm: function() {
    var panels = [];
        ...
        echo 'var lang' . $l['code'] . ' = new Ext.Panel({
          ...
          items: [
            ...
            {xtype: \'textarea\', fieldLabel: \'' . $osC_Language->get('field_meta_description') . '\', name: \'meta_description[' . $l['id'] . ']\'},
            {
              ...
              name: \'articles_categories_url[' . $l['id'] . ']\'
            }
          ]
        });
