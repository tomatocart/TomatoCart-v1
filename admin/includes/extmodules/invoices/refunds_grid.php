...
?>
Toc.invoices.RefundsGrid = function(config) {
  ...
  config.cm = new Ext.grid.ColumnModel([
    ...
    {id: 'invoices-refunds-comments', header: '<?php echo $osC_Language->get('table_heading_comments');?>', dataIndex: 'comments', align: 'left'},
    {header: '<?php echo $osC_Language->get('table_heading_total_refund');?>', dataIndex: 'total_refund', width: 100, align: 'center'}
  ]);
  config.autoExpandColumn = 'invoices-refunds-comments';
  
  Toc.invoices.RefundsGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.invoices.RefundsGrid, Ext.grid.GridPanel);