...
*/
  ...
  include('modules_order_total_config_dialog.php');
  include('modules_order_total_grid.php');
?>

Ext.override(TocDesktop.ModulesOrderTotalWindow, {
  ...
  createWindow : function(){
    ...
    if(!win){
      var grid = new Toc.modules_order_total.ModulesOrderTotalGrid({owner: this});
