<?php
/*
  $Id: manufacturers_meta_info_panel.php $
...
Toc.manufacturers.MetaInfoPanel = function(config) {
  config = config || {};
  ...
  Toc.manufacturers.MetaInfoPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.manufacturers.MetaInfoPanel, Ext.TabPanel, {
  buildForm: function() {
    var panels = [];
