 ...
 */
  ...
  class osC_Payment_authorizenet_cc_sim extends osC_Payment_Admin {
 ...
 */
  ...
  function osC_Payment_authorizenet_cc_sim() {
    ...
    $this->_description = $osC_Language->get('payment_authorizenet_cc_sim_description');
    $this->_method_title = $osC_Language->get('payment_authorizenet_cc_sim_method_title');
    $this->_status = (defined('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_STATUS') && (MODULE_PAYMENT_AUTHORIZENET_CC_SIM_STATUS == '1') ? true : false);
    $this->_sort_order = (defined('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_SORT_ORDER') ? MODULE_PAYMENT_AUTHORIZENET_CC_SIM_SORT_ORDER : null);
  }
 ...
 */
  ...
  function isInstalled() {
    return (bool)defined('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_STATUS');
  }
 ...
 */
  ...
  function install() {
    ...
    $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable Authorize.net Credit Card SIM', 'MODULE_PAYMENT_AUTHORIZENET_CC_SIM_STATUS', '-1', 'Do you want to accept Authorize.net Credit Card SIM payments?', '6', '0', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
    $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Api Login ID', 'MODULE_PAYMENT_AUTHORIZENET_CC_SIM_API_LOGIN_ID', '', 'The login ID used for the Authorize.net service', '6', '0', now())");
    $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Api Transaction Key', 'MODULE_PAYMENT_AUTHORIZENET_CC_SIM_API_TRANSACTION_KEY', '', 'Transaction key used for encrypting data', '6', '0', now())");
    $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('MD5 Hash', 'MODULE_PAYMENT_AUTHORIZENET_CC_SIM_MD5_HASH', '', 'The MD5 hash value to verify transactions with', '6', '0', now())");
    ...
    $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Transaction Mode', 'MODULE_PAYMENT_AUTHORIZENET_CC_SIM_TRANSACTION_MODE', 'Test', 'Transaction mode used for processing orders', '6', '0', 'osc_cfg_set_boolean_value(array(\'Live\', \'Test\'))', now())");
    ...
    $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Set Order Status', 'MODULE_PAYMENT_AUTHORIZENET_CC_SIM_ORDER_STATUS_ID', '0', 'Set the status of orders made with this payment module to this value', '6', '0', 'osc_cfg_set_order_statuses_pull_down_menu', 'osc_cfg_use_get_order_status_title', now())");
  }
 ...
 */
  ...
  function getKeys() {
    if (!isset($this->_keys)) {
      $this->_keys = array('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_STATUS', 
                           'MODULE_PAYMENT_AUTHORIZENET_CC_SIM_API_LOGIN_ID', 
                           'MODULE_PAYMENT_AUTHORIZENET_CC_SIM_API_TRANSACTION_KEY', 
