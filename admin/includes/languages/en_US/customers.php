...
section_store_credits = Store Credits
section_wishlist = Wishlist

action_heading_update_blance = Update Balance
...
table_heading_customers_credits = Store Credits
table_heading_date_created = Date Created
table_heading_action = Action
table_heading_group_name = Customer Group
table_heading_date = Date
table_heading_blance = Blance
table_heading_customers_status = Status

table_heading_products_name = Products Name
...
field_notify_customer_by_email = Notify Customer By Email:
field_comments = Comments:

field_gender = Gender:
field_email_address = E-Mail Address:
field_customers_group = Customer Group:
field_ip_address = Customer IP Address:
field_number_of_logons = Number Of Logons:
field_date_last_logon = Last Logon Date:
...
store_credits_action_refund = Refund
store_credits_action_purchase = Purchase
store_credits_action_admin = Admin

button_update_balance = Update Balance
