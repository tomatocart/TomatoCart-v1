...
field_price_discount_groups = Price Discount Group:
field_manufacturer = Manufacturer:
field_quantity = Quantity:
field_weight = Weight:
field_date_available = Date Available:
field_minimum_order_quantity = Min. Order Quantity:
field_Maximum_order_quantity = Max. Order Quantity:
...
field_products_type = Product Type:
products_type_simple = Simple Product
products_type_vrtual = Virtual Product
products_type_downloadable = Downloadable Product
products_type_gift_certificate = Gift Certificate

field_file = File:
field_sample_file = Sample File:
field_number_of_downloads = Number of downloads:
field_number_of_accessible_days = Number of Accessible Days:

field_gift_certificates_type = Gift Certificate Type:
field_gift_certificates_amount_type = Gift Certificate Amount Type:
gift_certificate_type_email = Email Gift Certificate
gift_certificate_type_physical = Physical Gift Certificate
gift_certificate_type_fix_amount = Fix Amount
gift_certificate_type_open_amount = Open Amount
field_open_amount_min_value = Open Amount Min. Value:
field_open_amount_max_value = Open Amount Max. Value:
...
table_heading_xsell_products = Products
