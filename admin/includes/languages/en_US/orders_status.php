...
action_heading_batch_delete_order_statuses = Batch Delete Order Status

table_heading_order_statuses = Order Status
table_heading_public_flag = Public Status
table_heading_downloads_flag = Downloads Status
table_heading_returns_flag = Returns Status
table_heading_gift_certificates_flag = Gift Certificates Status
table_heading_action = Action

field_name = Name:
field_set_as_default = Set as Default?
field_public_flag = Public Status:
field_downloads_flag = Downloads Status:
field_returns_flag = Returns Status:
field_gift_certificates_flag = Gift Certificates Status:
...
introduction_batch_delete_order_statuses = Please verify the removal of the following order status.
